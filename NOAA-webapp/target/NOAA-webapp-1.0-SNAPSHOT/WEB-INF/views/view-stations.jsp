...
<form method="post" action="/noaa/viewStations">
    ...
    <table>
        ...
        %>
        <tr>
            <td><%=station.getStationId()%> <%=station.getWbanNumber()%>
            </td>
            <td><%=station.getStationName()%>
            </td>
            <td><%=station.getCountryId()%> <%=station.getStateOfUS()%>
            </td>
            <td><%=station.getLatitude()%> <%=station.getLongitude()%>
            </td>
        </tr>
        <%
            }
